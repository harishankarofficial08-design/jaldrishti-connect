...
const LD = {
    getComplaints:  () => JSON.parse(localStorage.getItem('jd_complaints_v7')  || '[]'),
    saveComplaints: (d) => {
        localStorage.setItem('jd_complaints_v7', JSON.stringify(d));
        if (typeof pushToSupabase === 'function') pushToSupabase('complaints', d);
    },
    getLocations:   () => JSON.parse(localStorage.getItem('jd_locations_v7')   || '[]'),
...
const SEED = {
    ...
    complaints: [
        { id:"JD-90432", user:"Sneha Sundi",               location:"Jigani Industrial Area (Border Zone)", lat:12.78330, lng:77.63330, category:"Illegal Midnight Effluent Discharge", description:"Dark, chemical-smelling runoff observed from a pipeline at 1:30 AM.", photo: "https://picsum.photos/seed/jd1/400/250", dateTime:"2026-07-16T01:30", status:"Investigating", remarks:"KSPCB Dispatcher: Patrol team assigned.", timeline:{ submitted:"2026-07-16T02:00", received:"2026-07-16T09:00", investigating:"2026-07-16T11:30", resolved:null } },
        { id:"JD-71043", user:"Anekal Farmer Association", location:"Anekal Lake Border (Resident Zone)",   lat:12.70990, lng:77.69890, category:"Borewell Water Contamination",         description:"Borewell water turned yellowish with strong chlorine-like smell.",          photo: "https://picsum.photos/seed/jd2/400/250", dateTime:"2026-07-12T08:00", status:"Resolved",     remarks:"Upstream pipe leak closed. 2,50,000 INR fine issued.", timeline:{ submitted:"2026-07-12T09:30", received:"2026-07-12T10:15", investigating:"2026-07-13T10:00", resolved:"2026-07-15T16:00" } },
        { id:"JD-91255", user:"Local Volunteer Group",     location:"Jigani APC Circle (Urban Zone)",       lat:12.78500, lng:77.63500, category:"Garbage Dumping in Water Body",        description:"Large amounts of solid waste and plastic bags are being dumped into the drain.", photo: "https://picsum.photos/seed/jd3/400/250", dateTime:"2026-07-18T14:20", status:"Investigating", remarks:"Case forwarded to solid waste management.", timeline:{ submitted:"2026-07-18T14:45", received:"2026-07-19T09:10", investigating:"2026-07-19T10:30", resolved:null } },
        { id:"JD-91880", user:"Muralidhar R.",             location:"Jigani Industrial Layout Phase 2",     lat:12.78000, lng:77.63000, category:"Chemical Foam Overflow",               description:"Toxic foam overflowing from the industrial drains onto the main road.",          photo: "https://picsum.photos/seed/jd4/400/250", dateTime:"2026-07-20T06:15", status:"Submitted",    remarks:"Pending initial review.", timeline:{ submitted:"2026-07-20T06:30", received:null, investigating:null, resolved:null } },
        { id:"JD-92101", user:"Anekal Town Resident",      location:"Anekal Town Centre",                   lat:12.71200, lng:77.70100, category:"Drinking Water Discoloration",         description:"Municipal tap water has been coming out with a brownish tint for the last 48 hours.", photo: "https://picsum.photos/seed/jd5/400/250", dateTime:"2026-07-19T08:30", status:"Investigating", remarks:"Water supply temporarily halted.", timeline:{ submitted:"2026-07-19T09:00", received:"2026-07-19T10:15", investigating:"2026-07-19T11:00", resolved:null } },
        { id:"JD-92334", user:"Ramesh K.",                 location:"Anekal Lake South Bank",               lat:12.70500, lng:77.69500, category:"Mass Fish Death",                      description:"Hundreds of dead fish have washed up on the southern banks of the lake.",        photo: "https://picsum.photos/seed/jd6/400/250", dateTime:"2026-07-20T06:45", status:"Submitted",    remarks:"High priority flag raised.", timeline:{ submitted:"2026-07-20T07:10", received:null, investigating:null, resolved:null } },
        { id:"JD-92850", user:"Jigani Tech Park Assoc",    location:"Jigani Internal Road 4",               lat:12.79000, lng:77.62500, category:"Suspicious Tanker Discharge",          description:"An unmarked tanker was seen dumping liquid waste into the open storm drain.",    photo: "https://picsum.photos/seed/jd7/400/250", dateTime:"2026-07-19T23:45", status:"Investigating", remarks:"CCTV footage requested.", timeline:{ submitted:"2026-07-20T00:15", received:"2026-07-20T07:00", investigating:"2026-07-20T08:30", resolved:null } },
        { id:"JD-93001", user:"Jigani Lake Watch",         location:"Jigani Lake",                          lat:12.7900,  lng:77.6400,  category:"Solid Waste Dumping",                  description:"Construction debris dumped right on the lakebed.",                               photo: "https://picsum.photos/seed/jd8/400/250", dateTime:"2026-07-20T10:15", status:"Submitted",    remarks:"Pending review.", timeline:{ submitted:"2026-07-20T10:30", received:null, investigating:null, resolved:null } },
        { id:"JD-93002", user:"Ravi Shankar",              location:"Anekal Industrial Feeder",             lat:12.7150,  lng:77.7050,  category:"Air and Water Pollution",              description:"Black smoke from factory mixing with highly acidic runoff into the drains.",     photo: "https://picsum.photos/seed/jd9/400/250", dateTime:"2026-07-20T11:00", status:"Investigating", remarks:"KSPCB team dispatched.", timeline:{ submitted:"2026-07-20T11:15", received:"2026-07-20T11:30", investigating:"2026-07-20T12:00", resolved:null } },
        { id:"JD-93003", user:"Anekal Market Assoc",       location:"Anekal Main Road",                     lat:12.7100,  lng:77.6900,  category:"Sewage Water Logging",                 description:"Drain overflow causing foul smelling water logging in front of the market.",     photo: "https://picsum.photos/seed/jd10/400/250", dateTime:"2026-07-20T12:30", status:"Submitted",    remarks:"Forwarded to municipality.", timeline:{ submitted:"2026-07-20T12:45", received:null, investigating:null, resolved:null } },
        { id:"JD-93004", user:"Anonymous",                 location:"Jigani Phase 1 Border",                lat:12.7850,  lng:77.6250,  category:"Pungent Chemical Odor",                description:"Unbearable smell resembling sulfur coming from the drainage canals.",            photo: "https://picsum.photos/seed/jd11/400/250", dateTime:"2026-07-20T13:45", status:"Investigating", remarks:"Air quality monitors triggered.", timeline:{ submitted:"2026-07-20T13:50", received:"2026-07-20T14:00", investigating:"2026-07-20T14:15", resolved:null } },
        { id:"JD-93005", user:"Jigani Auto Union",         location:"Jigani Main Road Circle",              lat:12.7880,  lng:77.6350,  category:"Toxic Dust Emission",                  description:"Thick layer of unidentified white powder coating vehicles overnight.",            photo: "https://picsum.photos/seed/jd12/400/250", dateTime:"2026-07-21T07:15", status:"Submitted",    remarks:"Pending air quality verification.", timeline:{ submitted:"2026-07-21T07:20", received:null, investigating:null, resolved:null } },
        { id:"JD-93006", user:"Lake Conservation NGO",     location:"Anekal Lake East Bank",                lat:12.7110,  lng:77.7020,  category:"Wetland Encroachment",                 description:"Trucks seen dumping soil directly into the lake's eastern wetland buffer zone.", photo: "https://picsum.photos/seed/jd13/400/250", dateTime:"2026-07-21T09:40", status:"Investigating", remarks:"Survey department dispatched.", timeline:{ submitted:"2026-07-21T09:45", received:"2026-07-21T10:00", investigating:"2026-07-21T10:30", resolved:null } },
        { id:"JD-93007", user:"Suresh",                    location:"Anekal APMC Yard",                     lat:12.7180,  lng:77.7000,  category:"Rotting Organic Waste",                description:"Hundreds of kilos of unsold vegetable waste rotting in the open drain.",          photo: "https://picsum.photos/seed/jd14/400/250", dateTime:"2026-07-21T11:10", status:"Investigating", remarks:"Municipality cleanup crew assigned.", timeline:{ submitted:"2026-07-21T11:15", received:"2026-07-21T11:30", investigating:"2026-07-21T12:00", resolved:null } },
        { id:"JD-93008", user:"Jigani Layout Residents",   location:"Jigani Phase 2 Residential Layout",    lat:12.7780,  lng:77.6250,  category:"Groundwater Contamination",            description:"Three local borewells have started yielding muddy, oily water since last week.", photo: "https://picsum.photos/seed/jd15/400/250", dateTime:"2026-07-21T13:20", status:"Submitted",    remarks:"KSPCB testing team scheduled.", timeline:{ submitted:"2026-07-21T13:25", received:null, investigating:null, resolved:null } },
        { id:"JD-93009", user:"Green Anekal",              location:"Anekal Town Outskirts",                lat:12.7050,  lng:77.7100,  category:"Illegal Tree Felling",                 description:"Multiple mature banyan trees chopped down near the drainage canal.",             photo: "https://picsum.photos/seed/jd16/400/250", dateTime:"2026-07-21T14:45", status:"Investigating", remarks:"Forest department alerted.", timeline:{ submitted:"2026-07-21T14:50", received:"2026-07-21T15:00", investigating:"2026-07-21T15:30", resolved:null } },
        { id:"JD-93010", user:"Jigani Industrial Workers", location:"Jigani Industrial Area Phase 1",       lat:12.7820,  lng:77.6380,  category:"Hazardous Chemical Spill",             description:"Large blue drum tipped over leaking unidentified solvent onto the walkway.",     photo: "https://picsum.photos/seed/jd17/400/250", dateTime:"2026-07-21T16:10", status:"Investigating", remarks:"Hazmat response team en route.", timeline:{ submitted:"2026-07-21T16:15", received:"2026-07-21T16:20", investigating:"2026-07-21T16:30", resolved:null } },
        { id:"JD-93011", user:"Meena",                     location:"Anekal Post Office Road",              lat:12.7130,  lng:77.6970,  category:"Plastic Burning",                      description:"Local scrap yard burning large quantities of PVC pipes and plastic waste.",      photo: "https://picsum.photos/seed/jd18/400/250", dateTime:"2026-07-21T17:30", status:"Submitted",    remarks:"Police patrolling unit notified.", timeline:{ submitted:"2026-07-21T17:35", received:null, investigating:null, resolved:null } },
        { id:"JD-93012", user:"Jigani Electronics Hub",    location:"Jigani Electronic Park",               lat:12.7850,  lng:77.6300,  category:"E-Waste Dumping",                      description:"Hundreds of discarded circuit boards dumped in the empty plot next to the park.",photo: "https://picsum.photos/seed/jd19/400/250", dateTime:"2026-07-21T18:45", status:"Investigating", remarks:"E-waste management board notified.", timeline:{ submitted:"2026-07-21T18:50", received:"2026-07-21T19:00", investigating:"2026-07-21T19:15", resolved:null } },
        { id:"JD-93013", user:"Kiran",                     location:"Anekal Government Hospital",           lat:12.7100,  lng:77.6950,  category:"Biomedical Waste Overflow",            description:"Yellow and red biohazard bags piling up outside the designated disposal area.",  photo: "https://picsum.photos/seed/jd20/400/250", dateTime:"2026-07-21T19:20", status:"Submitted",    remarks:"Health officer informed.", timeline:{ submitted:"2026-07-21T19:25", received:null, investigating:null, resolved:null } },
        { id:"JD-93014", user:"Jigani Food Processing",    location:"Jigani Phase 3",                       lat:12.7950,  lng:77.6450,  category:"Organic Sludge Discharge",             description:"Factory discharging untreated thick sludge directly into stormwater drain.",     photo: "https://picsum.photos/seed/jd21/400/250", dateTime:"2026-07-21T20:10", status:"Investigating", remarks:"KSPCB inspection scheduled.", timeline:{ submitted:"2026-07-21T20:15", received:"2026-07-21T20:30", investigating:"2026-07-21T21:00", resolved:null } }
    ],
    industries: [
