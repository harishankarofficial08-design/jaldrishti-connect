...
const DEFAULT_COMPLAINTS = [
    {
        ...
        photo: "https://loremflickr.com/400/250/chemical?lock=1",
...

    {
        ...
        photo: "https://loremflickr.com/400/250/sewage?lock=2",
    ...
    },
    {
        ...
        photo: "https://loremflickr.com/400/250/garbage?lock=3",
    ...
    },
    {
        ...
        photo: "https://loremflickr.com/400/250/chemical?lock=4",
    ...
    },
    {
        ...
        photo: "https://loremflickr.com/400/250/sewage?lock=5",
    ...
    },
    {
        ...
        photo: "https://loremflickr.com/400/250/deadfish,lake?lock=6",
...

    {
        ...
        photo: "https://loremflickr.com/400/250/pollution?lock=7",
    ...
    },
    {
        ...
        photo: "https://loremflickr.com/400/250/garbage?lock=8",
    ...
    },
    {
        ...
        photo: "https://loremflickr.com/400/250/sewage?lock=9",
    ...
    },
    {
        ...
        photo: "https://loremflickr.com/400/250/sewage?lock=10",
    ...
    },
    {
        ...
        photo: "https://loremflickr.com/400/250/chemical?lock=11",
    ...
    },
    {
        ...
        photo: "https://loremflickr.com/400/250/smog?lock=12", dateTime: "2026-07-21T07:15",
    ...
    },
    {
        ...
        photo: "https://loremflickr.com/400/250/deforestation?lock=13", dateTime: "2026-07-21T09:40",
    ...
    },
    {
        ...
        photo: "https://loremflickr.com/400/250/garbage?lock=14", dateTime: "2026-07-21T11:10",
    ...
    },
    {
        ...
        photo: "https://loremflickr.com/400/250/sewage?lock=15", dateTime: "2026-07-21T13:20",
    ...
    },
    {
        ...
        photo: "https://loremflickr.com/400/250/deforestation?lock=16", dateTime: "2026-07-21T14:45",
    ...
    },
    {
        ...
        photo: "https://loremflickr.com/400/250/chemical?lock=17", dateTime: "2026-07-21T16:10",
    ...
    },
    {
        ...
        photo: "https://loremflickr.com/400/250/plastic,trash?lock=18", dateTime: "2026-07-21T17:30",
    ...
    },
    {
        ...
        photo: "https://loremflickr.com/400/250/garbage?lock=19", dateTime: "2026-07-21T18:45",
    ...
    },
    {
        ...
        photo: "https://loremflickr.com/400/250/garbage?lock=20", dateTime: "2026-07-21T19:20",
    ...
    },
    {
        ...
        photo: "https://loremflickr.com/400/250/pollution?lock=21", dateTime: "2026-07-21T20:10",
...
function initDatabase() {
    if (!localStorage.getItem("jd_locations_v8")) {
        localStorage.setItem("jd_locations_v8", JSON.stringify(DEFAULT_LOCATIONS));
    }
    if (!localStorage.getItem("jd_complaints_v8")) {
        localStorage.setItem("jd_complaints_v8", JSON.stringify(DEFAULT_COMPLAINTS));
    }
...
// Data Access Helpers
const getComplaints = () => JSON.parse(localStorage.getItem("jd_complaints_v8"));
const getLocations = () => JSON.parse(localStorage.getItem("jd_locations_v8"));
...
const saveLocations = (data) => {
    localStorage.setItem("jd_locations_v8", JSON.stringify(data));
    if (typeof pushToSupabase === 'function') pushToSupabase('locations', data);
};
const saveComplaints = (data) => {
    localStorage.setItem("jd_complaints_v8", JSON.stringify(data));
