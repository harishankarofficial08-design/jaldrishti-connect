...
const DEFAULT_COMPLAINTS = [
    {
        ...
        photo: "https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?auto=format&fit=crop&q=80&w=400",
...

    {
        ...
        photo: "https://images.unsplash.com/photo-1583212292454-1fe6229603b7?auto=format&fit=crop&q=80&w=400",
    ...
    },
    {
        ...
        photo: "https://images.unsplash.com/photo-1532996122724-e3c354a0b15b?auto=format&fit=crop&q=80&w=400",
    ...
    },
    {
        ...
        photo: "https://images.unsplash.com/photo-1473448912268-2022ce9509d8?auto=format&fit=crop&q=80&w=400",
    ...
    },
    {
        ...
        photo: "https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?auto=format&fit=crop&q=80&w=400", dateTime: "2026-07-21T07:15",
    ...
    },
    {
        ...
        photo: "https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?auto=format&fit=crop&q=80&w=400", dateTime: "2026-07-21T09:40",
    ...
    },
    {
        ...
        photo: "https://images.unsplash.com/photo-1532996122724-e3c354a0b15b?auto=format&fit=crop&q=80&w=400", dateTime: "2026-07-21T11:10",
    ...
    },
    {
        ...
        photo: "https://images.unsplash.com/photo-1583212292454-1fe6229603b7?auto=format&fit=crop&q=80&w=400", dateTime: "2026-07-21T13:20",
    ...
    },
    {
        ...
        photo: "https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?auto=format&fit=crop&q=80&w=400", dateTime: "2026-07-21T14:45",
    ...
    },
    {
        ...
        photo: "https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?auto=format&fit=crop&q=80&w=400", dateTime: "2026-07-21T16:10",
    ...
    },
    {
        ...
        photo: "https://images.unsplash.com/photo-1532996122724-e3c354a0b15b?auto=format&fit=crop&q=80&w=400", dateTime: "2026-07-21T17:30",
    ...
    },
    {
        ...
        photo: "https://images.unsplash.com/photo-1532996122724-e3c354a0b15b?auto=format&fit=crop&q=80&w=400", dateTime: "2026-07-21T18:45",
    ...
    },
    {
        ...
        photo: "https://images.unsplash.com/photo-1532996122724-e3c354a0b15b?auto=format&fit=crop&q=80&w=400", dateTime: "2026-07-21T19:20",
    ...
    },
    {
        ...
        photo: "https://images.unsplash.com/photo-1583212292454-1fe6229603b7?auto=format&fit=crop&q=80&w=400", dateTime: "2026-07-21T20:10",
...
function initDatabase() {
    if (!localStorage.getItem("jd_locations_v9")) {
        localStorage.setItem("jd_locations_v9", JSON.stringify(DEFAULT_LOCATIONS));
    }
    if (!localStorage.getItem("jd_complaints_v9")) {
        localStorage.setItem("jd_complaints_v9", JSON.stringify(DEFAULT_COMPLAINTS));
    }
...
// Data Access Helpers
const getComplaints = () => JSON.parse(localStorage.getItem("jd_complaints_v9"));
const getLocations = () => JSON.parse(localStorage.getItem("jd_locations_v9"));
...
const saveLocations = (data) => {
    localStorage.setItem("jd_locations_v9", JSON.stringify(data));
    if (typeof pushToSupabase === 'function') pushToSupabase('locations', data);
};
const saveComplaints = (data) => {
    localStorage.setItem("jd_complaints_v9", JSON.stringify(data));
