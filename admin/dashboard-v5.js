...
const DEFAULT_COMPLAINTS = [
    ...
    },
    {
        ...
        photo: "assets/real4.jpg.jpeg", dateTime: "2026-07-21T07:15",
    ...
    },
    {
        ...
        photo: "assets/real5.jpg.jpeg", dateTime: "2026-07-21T09:40",
    ...
    },
    {
        ...
        photo: "assets/real6.jpg.jpeg", dateTime: "2026-07-21T11:10",
    ...
    },
    {
        ...
        photo: "assets/real7.jpg.jpeg", dateTime: "2026-07-21T13:20",
    ...
    },
    {
        ...
        photo: "assets/real8.jpg.jpeg", dateTime: "2026-07-21T14:45",
    ...
    },
    {
        ...
        photo: "assets/real1.jpg.jpeg", dateTime: "2026-07-21T16:10",
    ...
    },
    {
        ...
        photo: "assets/real2.jpg.jpeg", dateTime: "2026-07-21T17:30",
    ...
    },
    {
        ...
        photo: "assets/real3.jpg.jpeg", dateTime: "2026-07-21T18:45",
    ...
    },
    {
        ...
        photo: "assets/real4.jpg.jpeg", dateTime: "2026-07-21T19:20",
    ...
    },
    {
        ...
        photo: "assets/real5.jpg.jpeg", dateTime: "2026-07-21T20:10",
...
function initDatabase() {
    if (!localStorage.getItem("jd_locations_v10")) {
        localStorage.setItem("jd_locations_v10", JSON.stringify(DEFAULT_LOCATIONS));
    }
    if (!localStorage.getItem("jd_complaints_v10")) {
        localStorage.setItem("jd_complaints_v10", JSON.stringify(DEFAULT_COMPLAINTS));
    }
...
// Data Access Helpers
const getComplaints = () => JSON.parse(localStorage.getItem("jd_complaints_v10"));
const getLocations = () => JSON.parse(localStorage.getItem("jd_locations_v10"));
...
const saveLocations = (data) => {
    localStorage.setItem("jd_locations_v10", JSON.stringify(data));
    if (typeof pushToSupabase === 'function') pushToSupabase('locations', data);
};
const saveComplaints = (data) => {
    localStorage.setItem("jd_complaints_v10", JSON.stringify(data));
